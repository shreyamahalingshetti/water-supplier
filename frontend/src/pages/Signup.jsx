      ...
      <div className="w-full max-w-md p-6 bg-[#FFFFFF] border border-[#8D6E63]/30 rounded-xl shadow-md flex flex-col items-center">
        ...
        {signupSuccess ? (
          <div className="w-full text-center space-y-4">
            <p className="text-base font-semibold text-[#8D6E63]">
          ...
          <form onSubmit={handleSignupSubmit} className="w-full space-y-4">
            {/* Full Name Field */}
            <div>
              <label className="block text-sm font-semibold text-[#8D6E63] mb-1">Full Name</label>
              <input
                type="text"
                value={name}
                onChange={(e) => setName(e.target.value)}
                className="w-full px-4 py-3 bg-[#FFFFFF] border border-[#8D6E63] rounded-lg focus:ring-2 focus:ring-[#4FC3F7] focus:border-[#4FC3F7] transition-all text-base outline-none text-[#8D6E63] placeholder-[#8D6E63]/50"
                placeholder="John Doe"
              />
              {errors.name && (
                <span className="text-xs text-[#8D6E63] mt-1 block font-semibold">
                  * {errors.name}
                </span>
              )}
            </div>
            ...
            {/* Phone Number Field */}
            <div>
              <label className="block text-sm font-semibold text-[#8D6E63] mb-1">Phone Number</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-base text-[#8D6E63] border-r border-[#8D6E63]/30 pr-2">
                  +91
                </span>
                <input
                  type="tel"
                  ...
                  className="w-full pl-14 pr-4 py-3 bg-[#FFFFFF] border border-[#8D6E63] rounded-lg focus:ring-2 focus:ring-[#4FC3F7] focus:border-[#4FC3F7] transition-all text-base outline-none text-[#8D6E63] placeholder-[#8D6E63]/50"
            ...
            {/* Area/Locality Field */}
            <div>
              <label className="block text-sm font-semibold text-[#8D6E63] mb-1">Area/Locality</label>
              <input
                type="text"
                value={area}
